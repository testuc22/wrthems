...
jQuery(document).ready(function($){function add_header_sticky(){if($(window).scrollTop()>=50){$('.header-wrapper').addClass('sticky-header');}else{$('.header-wrapper').removeClass('sticky-header');}}$(window).scroll(add_header_sticky);add_header_sticky();$("a.menu-bar").click(function(){$('body').toggleClass('menubar-show')});$(document).on('keyup',function(ev){if(ev.keyCode==27){$(".menubar-show").removeClass();}});});
